...
class Persianmagento_Zarinpalzar_Model_zarinpalzar extends Mage_Payment_Model_Method_Abstract 
{
	protected $_code = 'zarinpalzar';	
	protected $_formBlockType = 'zarinpalzar/form';
	protected $_infoBlockType = 'zarinpalzar/info';	
	...
	public function getOrderPlaceRedirectUrl()	{
		return Mage::getUrl ( 'zarinpalzar/redirect/redirect', array ('_secure' => true ) );
	}
	...
	public function getUrl() {
        ...
        $client->soap_defencoding = 'UTF-8';
			...
			$callBackUrl 	= ($this->getConfigData ('ssl_enabled')? 'https://' :'http://').$_SERVER['HTTP_HOST'].'/index.php' .'/zarinpalzar/redirect/success/';
				...
				if ($result['Status'] == 100) {
						...
						$msg 	= Mage::Helper('zarinpalzar')->getBankMessage($result['Status']);
						$this->getOrder ();													
